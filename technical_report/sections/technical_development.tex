...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[>=stealth, font=\small]
        ...
        % Scraper Manager (Client) - Top Left
        \node[draw, rectangle, minimum width=4cm, minimum height=1.5cm, align=center] (manager) at (-3.5, 0) {
        ...
        % Interface - Top Right
        \node[draw, rectangle, minimum width=4cm, minimum height=1.5cm, align=center] (interface) at (3.5, 0) {
        ...
        % Specific Adapter - Bottom Left
        \node[draw, rectangle, minimum width=4cm, minimum height=1.5cm, align=center] (specific) at (-3.5, -2.8) {
        ...
        % Generic Adapter - Bottom Right
        \node[draw, rectangle, minimum width=4cm, minimum height=1.5cm, align=center] (generic) at (3.5, -2.8) {
        ...
        % Relations
        % 1. Manager uses Interface (Horizontal, Left to Right)
        \draw[->, dashed] (manager.east) -- node[above] {uses} (interface.west);
        
        % 2. Generic implements Interface (Vertical, Bottom to Top)
        \draw[->, dashed] (generic.north) -- node[right] {implements} (interface.south);
        
        % 3. Edinburgh extends Generic (Horizontal, Left to Right)
        \draw[->] (specific.east) -- node[above] {extends} (generic.west);
...
\begin{enumerate}
    ...
    \item \textbf{Contextual Drill-Down:} Clicking any course row opens a comprehensive ``Detailed View''. This isolates the course to present historical fee comparisons, granular entry requirements, and crucially, a direct hyperlink to the \textit{original source URL}. Providing this source link allows analysts to manually verify the scraped data if an anomaly appears.
